...
void SamuCam::run()
{
  ...
  std::string faceXML = "/home/akos/Asztal/Prog. 2/bhax/codes/hello_codes/SamuCam/lbpcascade_frontalface.xml"; // https://github.com/Itseez/opencv/tree/master/data/lbpcascades
